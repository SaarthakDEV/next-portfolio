...
const Hero = () => {
  return (
    <section id="home" className="h-[100vh] relative overflow-hidden max-w-6xl container mx-auto">
      <Background />
      <div className="relative mt:mt-25 px-4 mt-30 text-center justify-center">
      <Tag />
